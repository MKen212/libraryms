...
<head>
  ...
  <title>Library MS - Return Books</title>
        ...
        <div class="sidebar-sticky">
          ...
          <?php if ($_SESSION["userIsAdmin"] == true) { ?>
            ...
            <ul class="nav flex-column">
              ...
              <!-- Return Books -->
              <li class="nav-item">
                <a class="nav-link active" href="main-booksIssuedRtn.php"><span data-feather="arrow-down-circle"></span>
                Return Books</a>  
              </li>
              <!-- Add Books -->
              <li class="nav-item">
