...
<head>
  ...
  <title>Library MS - Send Message</title>
      ...
      <nav class="col-md-2 d-none d-md-block bg-light sidebar">
        <div class="sidebar-sticky">
          <ul class="nav flex-column">
            ...
            <!-- Send a Message -->
            <li class="nav-item">
              <a class="nav-link active" href="main-messagesSend.php"><span data-feather="send"></span>Send a Message</a>
              <hr />
            </li>
            <!-- My Profile -->
            <li class="nav-item">
